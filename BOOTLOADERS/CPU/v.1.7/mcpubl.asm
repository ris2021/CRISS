...
.MACRO 	beep
	...
	cbi	PORTD, PD1
	_out	PORTB, (1<<PB1)|(1<<PB0)  	; select BUZZER
	tdelay 	250
	tdelay 	250
	tdelay 	250
...
START:
	; switch on SIG lamp
	_out	PORTB, (1<<PB0)|(1<<PB1)|(1<<PB2)
	_out	DDRB, (1<<PB0)|(1<<PB1)|(1<<PB2)|(1<<PB4)|(1<<PB7)|(1<<PB5)
	...
	_out	PORTB, (1<<PB1)|(1<<PB2)	; reset CPD command
...
BL01:
	...
	_out	PORTB, (1<<PB0)|(1<<PB1)|(1<<PB2)	; SIG lamp on 
